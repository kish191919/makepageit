    ...
    <div className="bg-[#faf7f2] text-[#1c3829]">
      ...
      <section className="relative flex min-h-[80vh] items-end overflow-hidden md:min-h-[88vh]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-16 pt-24 md:pb-24">
          ...
          <h1 className="mt-6 max-w-2xl font-serif text-4xl leading-[1.15] text-white md:text-6xl break-keep text-balance">
      ...
      <section id="contact" className="mx-auto max-w-6xl scroll-mt-24 px-6 py-16 sm:py-24">
        <div className="grid gap-12 md:grid-cols-2 md:items-start">
          <div>
            ...
            <p className="mt-6 leading-relaxed text-[#1c3829]/70 break-keep text-pretty">{t.contact.body}</p>
          ...
          <form className="rounded-sm bg-[#1c3829] p-6 text-white sm:p-10">
            <h3 className="font-serif text-2xl break-keep text-balance">{t.contact.formTitle}</h3>
            <p className="mt-2 text-xs text-white/60 break-keep text-pretty">{t.contact.formNote}</p>
