...
const beforeAfter = [
  {
    ...
    weeks: "8주",
    drop: "-9.2kg",
    img: "https://images.unsplash.com/photo-1599058917212-d750089bc07e?w=900&q=80&auto=format&fit=crop",
  },
  {
    name: "40대 주부 P님",
    weeks: "12주",
...
export default function DrSlimClinic() {
  return (
    <div className="min-h-screen bg-white text-slate-900">
      <header className="bg-white shadow-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          <div className="text-xl font-black tracking-tight">
            DR.<span className="text-[#0091ff]">SLIM</span>
          </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 md:grid-cols-[1.1fr_1fr] md:items-center md:py-20">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-black leading-[1.15] md:text-6xl">
              <span className="rounded bg-yellow-200 px-1.5">3개월 -12kg</span>,
              <br />
              요요 없이 만든
              <br />
              체질 다이어트.
            ...
            <ul className="mt-6 space-y-2 text-sm text-slate-700 md:text-base">
              <li>✅ 12,400명 임상 데이터로 검증</li>
              <li>✅ 1:1 원장 직접 진료 + 매주 면담</li>
              <li>✅ 굶지 않는 한식 식단 코칭</li>
            </ul>

            <div className="mt-8 rounded-2xl bg-white p-5 shadow-2xl ring-1 ring-slate-100">
              <p className="text-sm font-bold">📋 30초 무료 체질 진단</p>
              ...
              <p className="mt-2 text-[11px] text-slate-400">* 1분 안에 매니저가 카톡으로 연락드립니다.</p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <h2 className="text-center text-3xl font-black md:text-4xl">
          <span className="text-[#0091ff]">실제 환자</span>의 변화
        </h2>
        <p className="mt-3 text-center text-sm text-slate-500">동의받은 케이스만 노출됩니다 (모자이크 처리)</p>
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-center text-3xl font-black md:text-4xl">실제 후기</h2>
      ...
      <section className="bg-[#0091ff] py-16 text-white">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-3xl font-black md:text-5xl">올해는, 정말 빼봅시다.</h2>
          <p className="mt-4 text-white/90">4월 무료 상담 일주일 단 50명 한정</p>
      ...
      <footer className="bg-slate-900 py-6 text-center text-[11px] text-slate-400">
        의료광고 사전심의필 제2025-1234호 · 닥터슬림 의원 · 대표원장 김OO
      </footer>
    </div>
  );
}
