...
export default function AnchorPointLogistics({ lang }: { lang: Lang }) {
  ...
  return (
    <div className="bg-[#0f1b2d] text-[#eef2f7]">
      <header className="border-b border-white/10 bg-[#0a1420]">
        ...
        {menuOpen && (
          <div className="border-t border-white/10 px-6 py-4 md:hidden">
            ...
            <a href="#contact" onClick={() => setMenuOpen(false)} className="mt-3 inline-block bg-[#3d8bff] px-5 py-2.5 text-xs font-bold uppercase tracking-widest text-[#0a1420]">
              {t.quoteCta}
            </a>
          </div>
        )}
