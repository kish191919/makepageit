...
const breads = [
  {
    ...
    desc: "프랑스 이즈니 버터 24겹",
    price: "4,200원",
    image: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=900&q=80&auto=format&fit=crop",
  },
  {
    name: "발효종 캄파뉴",
    desc: "5일 천연발효종 · 호밀 30%",
  ...
  },
  {
    ...
    desc: "발로나 다크 초콜릿 2조각",
    price: "4,800원",
    image: "https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=900&q=80&auto=format&fit=crop",
  },
  {
    name: "치즈 식빵",
    desc: "고다 + 모짜렐라 치즈 듬뿍",
  ...
  },
  {
    ...
    desc: "유기농 통밀 · 무설탕",
    price: "3,500원",
    image: "https://images.unsplash.com/photo-1551892374-ecf8754cf8b0?w=900&q=80&auto=format&fit=crop",
  },
  {
    name: "단호박 식빵",
    desc: "국산 단호박 35% 함유",
    price: "8,500원",
    image: "https://images.unsplash.com/photo-1568254183919-78a4f43a2877?w=900&q=80&auto=format&fit=crop",
  },
];

export default function SeoulBakery() {
  return (
    <div className="bg-[#fffaf2] text-[#3a2418]">
      <header className="border-b border-[#e8d6bc] bg-[#fffaf2]/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold">서울 베이커리</span>
          </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:items-center md:py-24">
          <div>
            ...
            <h1 className="mt-5 text-5xl font-extrabold leading-[1.1] md:text-6xl">
              새벽에 굽고,<br />
              <span className="text-[#c0681e]">아침에 도착</span>합니다.
            </h1>
            <p className="mt-5 max-w-md text-lg leading-relaxed text-[#5b3e2c]">
              오후 2시 주문까지 다음 날 아침 7시 도착. 빵은 식기 전이 가장 맛있으니까요.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="flex items-end justify-between">
          <div>
            <span className="text-xs font-bold tracking-[0.3em] text-[#c0681e]">TODAY'S BREAD</span>
            <h2 className="mt-2 text-4xl font-extrabold">오늘 구운 빵</h2>
          </div>
          <div className="hidden text-sm font-semibold text-[#c0681e] md:block">전체 보기 →</div>
        </div>
      ...
      <section className="bg-[#fff3df] py-20">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-2 md:items-center">
          ...
          <div>
            <span className="text-xs font-bold tracking-[0.3em] text-[#c0681e]">OUR STORY</span>
            <h2 className="mt-3 text-4xl font-extrabold leading-tight">
              한 사람의 빵집,<br />20년이 지났습니다.
            </h2>
            <p className="mt-6 leading-relaxed text-[#5b3e2c]">
              2005년 종로의 작은 빵집에서 시작한 서울 베이커리는, 매일 새벽 4시 한 사람의 손에서 시작됩니다.
              빵의 재료, 발효 시간, 굽는 온도. 변하지 않은 것이 우리를 여기까지 데려왔습니다.
            </p>
            <a className="mt-8 inline-block font-bold text-[#c0681e] underline">제작 과정 보기 →</a>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#c0681e] py-20 text-white">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-4xl font-extrabold leading-tight md:text-5xl">
            오늘 새벽, 따뜻한 빵을<br />받아보세요.
          </h2>
          <p className="mt-4 text-white/90">서울 전 지역 무료배송 · 5만원 이상 주문 시</p>
      ...
      <footer className="bg-[#3a2418] py-10 text-sm text-[#d4b896]">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="font-bold text-white">서울 베이커리</div>
            <p className="mt-1 text-xs">서울 종로구 ○○로 ○○ · 02-000-0000</p>
          </div>
          <p className="text-xs">© 2025 Seoul Bakery. 사업자등록번호 000-00-00000</p>
        </div>
      </footer>
    </div>
  );
