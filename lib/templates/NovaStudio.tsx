    ...
    <div className="bg-black text-white">
      ...
      <section className="relative h-screen min-h-[640px] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 mx-auto flex max-w-7xl flex-col px-6 pb-20">
          <p className="text-xs uppercase tracking-[0.5em] text-white/70">Photographer · Seoul</p>
          ...
          <p className="mt-5 max-w-md text-sm text-white/70">
            한 컷에 담을 수 있는 가장 정직한 빛을, 가장 오래 남도록.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex items-end justify-between">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-white/50">2024 — 2025</span>
          </div>
      ...
      <section className="bg-white py-24 text-black">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-2 md:items-center">
          <div>
            <p className="text-xs uppercase tracking-[0.4em] text-black/50">Studio</p>
            <h2 className="mt-3 font-serif text-5xl leading-tight md:text-6xl">
              빛이<br />
              <span className="italic">기록이 되는</span><br />공간.
            </h2>
            <p className="mt-6 leading-relaxed text-black/70">
              성수동 끝, 햇빛이 가장 오래 머무는 4층. 자연광 스튜디오와 무한 백, 두 개의 공간에서 6년째 사진을 찍습니다.
            </p>
          </div>
      ...
      <section className="bg-black py-24">
        <div className="mx-auto max-w-6xl px-6">
          <p className="text-center text-xs uppercase tracking-[0.4em] text-white/50">Services</p>
          <h2 className="mt-3 text-center font-serif text-5xl">촬영 안내</h2>
      ...
      <section className="bg-black pb-24">
        <div className="mx-auto max-w-3xl px-6">
          <div className="rounded-none border border-white/20 p-10 md:p-14">
            <p className="text-xs uppercase tracking-[0.4em] text-white/50">Booking</p>
            <h2 className="mt-3 font-serif text-4xl">함께 작업해요.</h2>
            <p className="mt-3 text-sm text-white/60">
              촬영 일정과 컨셉을 알려주시면 24시간 내 답장드립니다.
            </p>
            <div className="mt-10 grid gap-6 sm:grid-cols-2">
              <input placeholder="이름" className="border-b border-white/30 bg-transparent pb-3 text-sm placeholder:text-white/40 outline-none" />
              <input placeholder="이메일" className="border-b border-white/30 bg-transparent pb-3 text-sm placeholder:text-white/40 outline-none" />
              <input placeholder="촬영 종류" className="border-b border-white/30 bg-transparent pb-3 text-sm placeholder:text-white/40 outline-none" />
              <input placeholder="희망 일자" className="border-b border-white/30 bg-transparent pb-3 text-sm placeholder:text-white/40 outline-none" />
            </div>
            <textarea rows={3} placeholder="레퍼런스 또는 메시지" className="mt-6 w-full border-b border-white/30 bg-transparent pb-3 text-sm placeholder:text-white/40 outline-none" />
      ...
      <footer className="border-t border-white/10 py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-6 text-xs uppercase tracking-[0.3em] text-white/40 md:flex-row">
          ...
          <div>© 2025 Nova Studio · Seoul</div>
