...
export default function HaruAcademy() {
  return (
    <div className="bg-white text-slate-900">
      <header className="border-b border-slate-100 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="text-xl font-black tracking-tight">
            하루<span className="text-[#ff5e3a]">영어</span>
          </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-[1.1fr_1fr] md:items-center md:py-24">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-black leading-[1.15] md:text-6xl">
              영어 등급, <br />
              <span className="text-[#ff5e3a]">한 학기 안에</span> 올립니다.
            </h1>
            <p className="mt-5 max-w-md text-lg text-slate-600">
              모의고사 5등급 학생도 6개월 안에 2등급. 312명의 실제 데이터로 증명합니다.
            </p>

            <div className="mt-10 rounded-2xl bg-white p-6 shadow-2xl ring-1 ring-slate-100">
              <p className="text-sm font-bold">🎁 6월 신규 등록 혜택</p>
              <ul className="mt-3 space-y-1.5 text-sm text-slate-700">
                <li>✓ 첫 달 수업료 50% 할인</li>
                <li>✓ 1:1 진단 상담 + 학습 로드맵 무료</li>
                <li>✓ 수능 기출 모의고사 무료 응시권</li>
              </ul>
              <form className="mt-5 flex flex-col gap-2 sm:flex-row">
                <input
                  placeholder="학부모님 연락처"
              ...
              <p className="mt-3 text-[11px] text-slate-400">* 1분 안에 담당 매니저가 연락드립니다.</p>
            </div>
          </div>
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-center text-3xl font-black md:text-4xl">
            왜 <span className="text-[#ff5e3a]">하루영어</span>인가?
          </h2>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="rounded-3xl bg-gradient-to-br from-slate-900 to-slate-700 p-10 text-white md:p-14">
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-[#ff5e3a]">Curriculum</p>
          <h2 className="mt-3 text-3xl font-black md:text-4xl">한 학기 단위 단계별 로드맵</h2>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <h2 className="text-center text-3xl font-black md:text-4xl">학부모님 후기</h2>
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="text-center text-3xl font-black md:text-4xl">자주 묻는 질문</h2>
      ...
      <section className="bg-[#ff5e3a] py-20 text-white">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-3xl font-black md:text-5xl">지금 바로, 한 학기 후의 등급을 바꾸세요.</h2>
          <p className="mt-4 text-white/80">무료 진단 상담은 일주일 단 30명 한정입니다.</p>
