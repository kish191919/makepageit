...
export default function AtelierShop() {
  return (
    <div className="bg-[#fafaf7] text-[#1f1d1a]">
      <header className="border-b border-[#ecead9] bg-[#fafaf7]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <div className="flex gap-5 text-xs uppercase tracking-widest">
            <a>Search</a>
            <a>Account</a>
            <a className="font-semibold">Cart (2)</a>
          </div>
        </div>
      </header>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="flex items-end justify-between">
          ...
          <div className="flex gap-3 text-xs uppercase tracking-widest">
            <a className="border-b border-[#1f1d1a] pb-0.5">All</a>
            <a className="text-[#7a7770]">Outerwear</a>
            <a className="text-[#7a7770]">Knit</a>
            <a className="text-[#7a7770]">Accessories</a>
          </div>
        </div>
      ...
      <section className="bg-[#1f1d1a] py-24 text-[#fafaf7]">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-2 md:items-center">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.4em] text-[#bcb8aa]">Our Story</p>
            <h2 className="mt-4 font-serif text-4xl leading-tight md:text-5xl">
              Twenty two<br />careful hands.
            </h2>
            <p className="mt-6 leading-relaxed text-[#d3cfc0]">
              매 시즌 22명의 장인이 한 점씩 직접 패턴을 떴습니다. 우리는 빠르게 만들 수 없는 옷만 만듭니다. 한 벌이 손에 닿기까지 평균 19시간이 걸립니다.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <p className="text-center text-xs uppercase tracking-[0.4em] text-[#7a7770]">Lookbook</p>
        <h2 className="mt-3 text-center font-serif text-4xl">In Bloom</h2>
      ...
      <section className="border-t border-[#ecead9] bg-[#fafaf7] py-20">
        <div className="mx-auto max-w-2xl px-6 text-center">
          <p className="text-xs uppercase tracking-[0.4em] text-[#7a7770]">Newsletter</p>
          <h2 className="mt-3 font-serif text-3xl">먼저 받아보는 시즌 룩북</h2>
          <p className="mt-3 text-sm text-[#5b5853]">신상 출시 1주 전, 가입자에게만 우선 안내드립니다.</p>
          <form className="mt-8 flex border-b-2 border-[#1f1d1a]">
            ...
            />
            <button className="text-xs font-semibold uppercase tracking-[0.3em]">Subscribe →</button>
          </form>
        </div>
      </section>
      ...
      <footer className="bg-[#fafaf7] py-12 text-xs uppercase tracking-widest text-[#7a7770]">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 md:flex-row">
          ...
          <div>© 2025 Atelier 22. Crafted in Seoul.</div>
        </div>
      </footer>
    </div>
  );
