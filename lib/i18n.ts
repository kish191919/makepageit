  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "First-year total", lite: "$499", pro: "$1,434" },
        { item: "Year 2 onward (annual)", lite: "$200", pro: "$985" },
  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "1년 총 예상비용", lite: "$499", pro: "$1,434" },
        { item: "2년차부터 매년 예상비용", lite: "$200", pro: "$985" },
