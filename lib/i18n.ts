  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "Monthly bundle (default)", lite: "$25", pro: "$55" },
        { item: "└ Hosting", lite: "$10/mo included", pro: "$10/mo included", isSub: true },
        { item: "└ Database", lite: "$10/mo optional add-on", pro: "$20/mo included", isSub: true },
        { item: "└ Maintenance", lite: "$15/mo included", pro: "$25/mo included", isSub: true },
        { item: "Domain (annual)", lite: "$25", pro: "$25" },
        { item: "First-year total", lite: "$724", pro: "$1,334" },
        { item: "Year 2 onward (annual)", lite: "$325", pro: "$685" },
  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "└ 데이터베이스", lite: "$10/월 선택 추가", pro: "$20/월 포함", isSub: true },
        { item: "└ 유지보수", lite: "$15/월 포함", pro: "$25/월 포함", isSub: true },
        { item: "연 도메인", lite: "$25", pro: "$25" },
        { item: "1년 총 예상비용", lite: "$724", pro: "$1,334" },
        { item: "2년차부터 매년 예상비용", lite: "$325", pro: "$685" },
