  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "Hosting + DB + maintenance (monthly)", lite: "$15", pro: "$80" },
        { item: "└ Hosting", lite: "Free (non-commercial)", pro: "$25/mo included", isSub: true },
        { item: "└ Database", lite: "Free (non-commercial)", pro: "$30/mo included", isSub: true },
        { item: "└ Maintenance", lite: "$15/mo included", pro: "$25/mo included", isSub: true },
        { item: "Domain (annual)", lite: "$25", pro: "$25" },
        { item: "First-year total", lite: "$504", pro: "$1,434" },
        { item: "Year 2 onward (annual)", lite: "$205", pro: "$985" },
  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "호스팅 + DB + 유지보수 (월비용)", lite: "$15", pro: "$80" },
        { item: "└ 호스팅", lite: "무료 (비상업용)", pro: "$25/월 포함", isSub: true },
        { item: "└ 데이터베이스", lite: "무료 (비상업용)", pro: "$30/월 포함", isSub: true },
        { item: "└ 유지보수", lite: "$15/월 포함", pro: "$25/월 포함", isSub: true },
        { item: "연 도메인", lite: "$25", pro: "$25" },
        { item: "1년 총 예상비용", lite: "$504", pro: "$1,434" },
        { item: "2년차부터 매년 예상비용", lite: "$205", pro: "$985" },
