  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "└ Hosting", lite: "$10/mo included", pro: "$20/mo included", isSub: true },
        { item: "└ Database", lite: "$10/mo included", pro: "$35/mo included", isSub: true },
  ...
  pricing: {
    ...
    compare: {
      ...
      rows: [
        ...
        { item: "└ 호스팅", lite: "$10/월 포함", pro: "$20/월 포함", isSub: true },
        { item: "└ 데이터베이스", lite: "$10/월 포함", pro: "$35/월 포함", isSub: true },
