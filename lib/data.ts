...
export const faqs: FAQ[] = [
  ...
  {
    q: "직접 수정하고 관리할 수 있나요?",
    a: "가벼운 텍스트·이미지 수정은 월 유지보수에 포함되어 있어 요청 주시면 바로 반영해드립니다. 직접 게시글·사진을 등록하고 싶으시면 PORTFOLIO PRO의 게시판·사진첩 옵션으로 관리자 페이지에서 직접 수정·관리하실 수 있어요. 사용법 교육도 함께 진행해드립니다.",
  },
  {
  ...
  {
    q: "오픈 후 운영도 맡길 수 있나요?",
    a: "네, 월 유지보수 비용에 콘텐츠 수정·기능 점검·성능 모니터링이 이미 포함되어 있습니다(LITE 월 $15 / PRO 월 $20). 더 큰 단위의 마케팅 운영(SEO 컨설팅, 블로그 콘텐츠, 광고 운영) 등은 분리 계약으로 진행하며, 자세한 비용은 무료 상담 시 안내드려요.",
  },
];
